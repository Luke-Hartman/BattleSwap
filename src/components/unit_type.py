...
class UnitTierComponent:
    """Component that stores the tier/experience level of a unit."""
    
    def __init__(self, tier: UnitTier = UnitTier.BASIC):
        """Initialize the UnitTier component.
        
        Args:
            tier: The tier of this unit (defaults to BASIC)
        """
        self.tier = tier
