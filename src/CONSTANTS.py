...
CORE_ARCHER_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8 / GAME_SPEED,
    AnimationType.WALKING: 0.6 / GAME_SPEED,
    AnimationType.ABILITY1: 1.8 / GAME_SPEED,
...
CRUSADER_GOLD_KNIGHT_EMPOWERED_DAMAGE_PERCENTAGE = 0.15
...
CRUSADER_LONGBOWMAN_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8 / GAME_SPEED,
    AnimationType.WALKING: 0.6 / GAME_SPEED,
    AnimationType.ABILITY1: 2.4 / GAME_SPEED,
    AnimationType.DYING: 0.6 / GAME_SPEED
}
...
CRUSADER_RED_KNIGHT_ATTACK_DAMAGE = 60 # hits twice
