...
HORSEMAN_ATTACK_DAMAGE = 60
HORSEMAN_MOVEMENT_SPEED = 45.0 * MINIFOLKS_SCALE * GAME_SPEED
...
FANCY_SWORDSMAN_HP = 100
FANCY_SWORDSMAN_ATTACK_RANGE = 40 * TINY_RPG_SCALE
...
LONGBOWMAN_HP = 60
LONGBOWMAN_ATTACK_RANGE = 300 * TINY_RPG_SCALE
LONGBOWMAN_ATTACK_DAMAGE = 30
LONGBOWMAN_MOVEMENT_SPEED = 20.0 * TINY_RPG_SCALE * GAME_SPEED
LONGBOWMAN_PROJECTILE_SPEED = 350.0 * TINY_RPG_SCALE * GAME_SPEED
LONGBOWMAN_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8 / GAME_SPEED,
    AnimationType.WALKING: 0.6 / GAME_SPEED,
