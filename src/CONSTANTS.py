...
CORE_MAGE_PROJECTILE_SPEED = 400.0
...
CORE_HORSEMAN_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 1.6,
    AnimationType.WALKING: 0.6,
    AnimationType.ABILITY1: 0.8,
    AnimationType.DYING: 1.5
}

CORE_DUELIST_HP = CORE_SWORDSMAN_HP
CORE_DUELIST_ATTACK_RANGE = 80
CORE_DUELIST_ATTACK_DAMAGE = 125
CORE_DUELIST_MOVEMENT_SPEED = 50
CORE_DUELIST_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 1.2,
    AnimationType.WALKING: 0.8,
    AnimationType.ABILITY1: 0.6,
    AnimationType.DYING: 0.8
}

CRUSADER_BLACK_KNIGHT_HP = CORE_SWORDSMAN_HP * 3.5
CRUSADER_BLACK_KNIGHT_ATTACK_RANGE = 70
CRUSADER_BLACK_KNIGHT_ATTACK_DAMAGE = 90
...
CRUSADER_BLACK_KNIGHT_AURA_RADIUS = 100
CRUSADER_BLACK_KNIGHT_AURA_DURATION = 3
CRUSADER_BLACK_KNIGHT_AURA_FLEE_DURATION = 1
...
CRUSADER_DEFENDER_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8,
    AnimationType.WALKING: 0.6,
    AnimationType.ABILITY1: 0.75,  # Note that attack animations effect attack speed
    AnimationType.DYING: 0.8
}
...
CRUSADER_LONGBOWMAN_PROJECTILE_SPEED = 525.0
CRUSADER_LONGBOWMAN_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8,
    AnimationType.WALKING: 0.6,
    AnimationType.ABILITY1: 3.6,
    AnimationType.DYING: 0.6
}
...
CRUSADER_PALADIN_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 1.6,
    AnimationType.WALKING: 0.77,
    AnimationType.ABILITY2: 0.8,  # Melee attack
    AnimationType.DYING: 1.5,
    AnimationType.ABILITY1: 1.2  # Heal
}
...
CRUSADER_RED_KNIGHT_SKILL_AOE_DURATION = 0.4
...
CRUSADER_RED_KNIGHT_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8,
    AnimationType.WALKING: 0.6,
    AnimationType.ABILITY1: 1.467,
    AnimationType.ABILITY2: 0.8,
    AnimationType.DYING: 0.8,
}
