...
CORE_ARCHER_MOVEMENT_SPEED = 50 * GAME_SPEED
...
CORE_MAGE_MOVEMENT_SPEED = 40 * GAME_SPEED
...
CRUSADER_BLACK_KNIGHT_ARMOR_FLAT_REDUCTION = 15
CRUSADER_BLACK_KNIGHT_ARMOR_PERCENT_REDUCTION = 0.1
...
CRUSADER_BLACK_KNIGHT_AURA_DAMAGE_PERCENT_REDUCTION = 0.15
...
CRUSADER_CLERIC_ANIMATION_DURATIONS = {
    ...
    AnimationType.ATTACKING: 2 / GAME_SPEED,
    AnimationType.DYING: 0.6 / GAME_SPEED
}

CRUSADER_COMMANDER_HP = 100
CRUSADER_COMMANDER_ARMOR_FLAT_REDUCTION = 15
CRUSADER_COMMANDER_ARMOR_PERCENT_REDUCTION = 0.1
...
CRUSADER_GOLD_KNIGHT_ARMOR_FLAT_REDUCTION = 15
CRUSADER_GOLD_KNIGHT_ARMOR_PERCENT_REDUCTION = 0.1
...
# Note that this affects ally melee damage, excluding self
# (can be buffed by a second gold knight aura)
CRUSADER_GOLD_KNIGHT_AURA_DAMAGE_PERCENT_BUFF = 0.15
CRUSADER_GOLD_KNIGHT_AURA_RADIUS = 200
...
CRUSADER_PALADIN_ARMOR_FLAT_REDUCTION = 15
CRUSADER_PALADIN_ARMOR_PERCENT_REDUCTION = 0.1
...
CRUSADER_PALADIN_ANIMATION_DURATIONS = {
    ...
    AnimationType.ATTACKING: 0.8 / GAME_SPEED,
    AnimationType.DYING: 1.5 / GAME_SPEED,
    AnimationType.SKILL: 1.2 / GAME_SPEED
}
CRUSADER_PALADIN_SKILL_COOLDOWN = 8.0
CRUSADER_PALADIN_SKILL_HEALTH_PERCENT_THRESHOLD = 0.5
...
CRUSADER_RED_KNIGHT_HP = 150
CRUSADER_RED_KNIGHT_ARMOR_FLAT_REDUCTION = 15
CRUSADER_RED_KNIGHT_ARMOR_PERCENT_REDUCTION = 0.1
CRUSADER_RED_KNIGHT_ATTACK_RANGE = 50
CRUSADER_RED_KNIGHT_ATTACK_DAMAGE = 75
CRUSADER_RED_KNIGHT_MOVEMENT_SPEED = 47 * GAME_SPEED
CRUSADER_RED_KNIGHT_SKILL_RANGE = 75
CRUSADER_RED_KNIGHT_SKILL_DAMAGE = 150
CRUSADER_RED_KNIGHT_SKILL_AOE_DURATION = 0.6 / GAME_SPEED
...
CRUSADER_RED_KNIGHT_ANIMATION_DURATIONS = {
    AnimationType.IDLE: 0.8 / GAME_SPEED,
    AnimationType.WALKING: 0.6 / GAME_SPEED,
    AnimationType.ATTACKING: 0.5 / GAME_SPEED,
    AnimationType.DYING: 0.8 / GAME_SPEED,
    AnimationType.SKILL: 2.2 / GAME_SPEED
}
