...
CRUSADER_BLACK_KNIGHT_MOVEMENT_SPEED = CORE_SWORDSMAN_MOVEMENT_SPEED * 1.5
...
CRUSADER_GOLD_KNIGHT_HP = CORE_SWORDSMAN_HP * 2.75
...
CRUSADER_PALADIN_ARMOR_FLAT_REDUCTION = 0
CRUSADER_PALADIN_ARMOR_PERCENT_REDUCTION = 0
