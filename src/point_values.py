...
spell_values: Dict[SpellType, int] = {
    ...
    SpellType.INFECTING_AREA: gc.SPELL_INFECTING_AREA_POINTS,
    SpellType.HEALING_AREA: gc.SPELL_HEALING_AREA_POINTS,
    SpellType.SLOWING_AREA: gc.SPELL_SLOWING_AREA_POINTS,
