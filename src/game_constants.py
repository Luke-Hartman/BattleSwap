...
class GameConstants(BaseModel):
    ...
    CORE_WIZARD_IGNITE_DAMAGE: float
    CORE_WIZARD_IGNITE_DURATION: float
    ...
    CRUSADER_BANNER_BEARER_MOVEMENT_SPEED: float
    ...
    # Guardian Angel
    GUARDIAN_ANGEL_HP: float
    GUARDIAN_ANGEL_HEALING: float
    GUARDIAN_ANGEL_MOVEMENT_SPEED: float
    GUARDIAN_ANGEL_ANIMATION_IDLE_DURATION: float
    GUARDIAN_ANGEL_ANIMATION_WALKING_DURATION: float
    GUARDIAN_ANGEL_ANIMATION_ATTACH_DURATION: float
    GUARDIAN_ANGEL_ANIMATION_HEAL_DURATION: float
    GUARDIAN_ANGEL_ANIMATION_DYING_DURATION: float
    GUARDIAN_ANGEL_ATTACHMENT_RANGE: float
