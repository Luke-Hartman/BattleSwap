...
class GameConstants(BaseModel):
    ...
    CRUSADER_BANNER_BEARER_POINTS: int
    CRUSADER_BLACK_KNIGHT_POINTS: int
    CRUSADER_CATAPULT_POINTS: int
    CRUSADER_CLERIC_POINTS: int
    CRUSADER_COMMANDER_POINTS: int
    CRUSADER_CROSSBOWMAN_POINTS: int
    CRUSADER_DEFENDER_POINTS: int
    CRUSADER_GOLD_KNIGHT_POINTS: int
    CRUSADER_GUARDIAN_ANGEL_POINTS: int
    CRUSADER_PALADIN_POINTS: int
    CRUSADER_PIKEMAN_POINTS: int
    CRUSADER_RED_KNIGHT_POINTS: int
    CRUSADER_SOLDIER_POINTS: int
    ...
    ZOMBIE_BRUTE_POINTS: int
    ZOMBIE_FIGHTER_POINTS: int
    ZOMBIE_GRABBER_POINTS: int
    ...
    # Grabber
    ZOMBIE_GRABBER_HP: float
    ZOMBIE_GRABBER_ATTACK_RANGE: float
    ZOMBIE_GRABBER_ATTACK_DAMAGE: float
    ZOMBIE_GRABBER_GRAB_DAMAGE: float
    ZOMBIE_GRABBER_GRAB_COOLDOWN: float
    ZOMBIE_GRABBER_GRAB_MINIMUM_RANGE: float
    ZOMBIE_GRABBER_GRAB_MAXIMUM_RANGE: float
    ZOMBIE_GRABBER_GRAB_PROJECTILE_SPEED: float
    ZOMBIE_GRABBER_GRAB_FORCED_MOVEMENT_SPEED: float
    ZOMBIE_GRABBER_MOVEMENT_SPEED: float
    ZOMBIE_GRABBER_ANIMATION_IDLE_DURATION: float
    ZOMBIE_GRABBER_ANIMATION_WALKING_DURATION: float
    ZOMBIE_GRABBER_ANIMATION_CHANNELING_DURATION: float
    ZOMBIE_GRABBER_ANIMATION_GRAB_DURATION: float
    ZOMBIE_GRABBER_ANIMATION_ATTACK_DURATION: float
    ZOMBIE_GRABBER_ANIMATION_DYING_DURATION: float
