...
GLOSSARY_ENTRIES = {
    ...
    GlossaryEntryType.POINTS: f"Points represent the value of units, items, and spells. When you have more than {gc.CORRUPTION_TRIGGER_POINTS} points of unused units, items, and spells in your <a href='{GlossaryEntryType.BARRACKS.value}'>Barracks</a>, <a href='{GlossaryEntryType.CORRUPTION.value}'>Corruption</a> will trigger.",
