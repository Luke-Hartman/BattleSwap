...
unit_values: Dict[UnitType, int] = {
    ...
    UnitType.CORE_LONGBOWMAN: 200,
    UnitType.CORE_SWORDSMAN: 100,
    UnitType.CORE_WIZARD: 300,
    UnitType.CRUSADER_BANNER_BEARER: 100,
    UnitType.CRUSADER_BLACK_KNIGHT: 300,
    UnitType.CRUSADER_CATAPULT: 300,
    UnitType.CRUSADER_CLERIC: 200,
    UnitType.CRUSADER_COMMANDER: 200,
    ...
    UnitType.CRUSADER_RED_KNIGHT: 200,
